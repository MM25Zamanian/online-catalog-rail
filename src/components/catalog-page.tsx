...
export function CatalogPage({ locale }: CatalogPageProps) {
  ...
  return (
    ...
    >
      ...
      <Slide01 locale={locale} copy={dictionary.slide01} brand={dictionary.brand}>
        <WorldMap className="bg-transparent absolute top-0 inset-x-0" />
      </Slide01>
      <Slide02 locale={locale} copy={dictionary.slide02} brand={dictionary.brand} />
      <Slide03 locale={locale} copy={dictionary.slide03} brand={dictionary.brand} />
